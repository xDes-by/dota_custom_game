LinkLuaModifier("modifier_npc_dota_hero_nevermore_agi8", "heroes/hero_nevermore/dmg", LUA_MODIFIER_MOTION_NONE)
...
if modifier_npc_dota_hero_nevermore_agi8 == nil then 
