...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_magnataur_skewer_lua_slow:GetEffectName()
	return "particles/units/heroes/hero_magnataur/magnataur_skewer_debuff.vpcf"
end

function modifier_magnataur_skewer_lua_slow:GetEffectAttachType()
	return PATTACH_ABSORIGIN_FOLLOW
end

-- function modifier_magnataur_skewer_lua_slow:GetStatusEffectName()
-- 	return "status/effect/here.vpcf"
-- end

-- function modifier_magnataur_skewer_lua_slow:StatusEffectPriority()
-- 	return MODIFIER_PRIORITY_NORMAL
-- end

-- function modifier_magnataur_skewer_lua_slow:PlayEffects()
-- 	-- Get Resources
