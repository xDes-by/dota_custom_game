...
-- function modifier_magnataur_skewer_lua_debuff:IsStunDebuff()
-- 	return true
-- end
...
function modifier_magnataur_skewer_lua_debuff:OnRefresh( kv )
	
end

function modifier_magnataur_skewer_lua_debuff:OnRemoved()
end

function modifier_magnataur_skewer_lua_debuff:OnDestroy()
	if not IsServer() then return end
...
-- function modifier_magnataur_skewer_lua_debuff:GetOverrideAnimation()
-- 	return ACT_DOTA_FLAIL
-- end

--------------------------------------------------------------------------------
-- Status Effects
-- function modifier_magnataur_skewer_lua_debuff:CheckState()
-- 	local state = {
...
--------------------------------------------------------------------------------
-- Motion Effects
-- function modifier_magnataur_skewer_lua_debuff:UpdateHorizontalMotion( me, dt )
...
-- function modifier_magnataur_skewer_lua_debuff:OnHorizontalMotionInterrupted()
-- 	self:Destroy()
-- end