...
LinkLuaModifier( "modifier_huskar_life_break_lua_buff", "heroes/hero_huskar/huskar_life_break_lua/modifier_huskar_life_break_lua_buff", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_huskar_life_break_lua_debuff", "heroes/hero_huskar/huskar_life_break_lua/modifier_huskar_life_break_lua_debuff", LUA_MODIFIER_MOTION_NONE )
