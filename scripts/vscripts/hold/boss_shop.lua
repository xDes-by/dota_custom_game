...
-- 	[1] = {
-- 		name = "pets",
-- 		[1] = {name = "ratingpoints_1", price = {rp = 250}, itemname = "item_pet_donate_simple_1", rarity = "#00ff48", text_color = "#00ff48", type = "pet", currency = "mmrpoints"},
-- 		[2] = {name = "ratingpoints_2", price = {rp = 350}, itemname = "item_pet_donate_simple_2", rarity = "#00ff48", text_color = "#00ff48", type = "pet", currency = "mmrpoints"},
-- 		[3] = {name = "ratingpoints_3", price = {rp = 450}, itemname = "item_pet_donate_simple_3", rarity = "#00ff48", text_color = "#00ff48", type = "pet", currency = "mmrpoints"},
-- 		[4] = {name = "pet_15", price = {don = 50}, itemname = "item_pet_donate_mana_regen", rarity = "#0044ff", text_color = "#0044ff", type = "pet"},
-- 		[5] = {name = "pet_13", price = {don = 50}, itemname = "item_pet_donate_hp_com", rarity = "#0044ff", text_color = "#0044ff", type = "pet"},
-- 		[6] = {name = "pet_14", price = {don = 50}, itemname = "item_pet_donate_dmg_com", rarity = "#0044ff", text_color = "#0044ff", type = "pet"},
-- 		[7] = {name = "pet_5", price = {don = 100}, itemname = "item_pet_donate_total_dmg", rarity = "#ffa600", text_color = "#ffa600", type = "pet"},
-- 		[8] = {name = "pet_6", price = {don = 100}, itemname = "item_pet_donate_int", rarity = "#ffa600", text_color = "#ffa600", type = "pet"},
-- 		[9] = {name = "pet_7", price = {don = 100}, itemname = "item_pet_donate_str", rarity = "#ffa600", text_color = "#ffa600", type = "pet"},
-- 		[10] = {name = "pet_8", price = {don = 100}, itemname = "item_pet_donate_agi", rarity = "#ffa600", text_color = "#ffa600", type = "pet"},
-- 		[11] = {name = "pet_9", price = {don = 100}, itemname = "item_pet_donate_heal", rarity = "#ffa600", text_color = "#ffa600", type = "pet"},
-- 		[12] = {name = "pet_1", price = {don = 150}, itemname = "item_pet_donate_dmg", rarity = "#d400ff", text_color = "#d400ff", type = "pet"},
-- 		[13] = {name = "pet_2", price = {don = 150}, itemname = "item_pet_donate_hp", rarity = "#d400ff", text_color = "#d400ff", type = "pet"},
-- 		[14] = {name = "pet_3", price = {don = 150}, itemname = "item_pet_donate_fast", rarity = "#d400ff", text_color = "#d400ff", type = "pet"},
-- 		[15] = {name = "pet_4", price = {don = 150}, itemname = "item_pet_donate_cleave", rarity = "#d400ff", text_color = "#d400ff", type = "pet"},
-- 		[16] = {name = "pet_10", price = {don = 150}, itemname = "item_pet_donate_block", rarity = "#d400ff", text_color = "#d400ff", type = "pet"},
-- 		[17] = {name = "pet_11", price = {don = 150}, itemname = "item_pet_donate_all_dmg_amp", rarity = "#d400ff", text_color = "#d400ff", type = "pet"},
-- 		[18] = {name = "pet_12", price = {don = 150}, itemname = "item_pet_donate_gold", rarity = "#d400ff", text_color = "#d400ff", type = "pet"},
-- 	},
-- 	[2] = {
-- 		name = "consumables",
...
_G.basicshop = {
    [1] = {
		...
		[3] = {panorama_name = 'panorama_item_3', name = "item_3", price = {don = 50}, itemname = "item_pet_donate_dmg_com", rarity = "#0044ff", text_color = "#0044ff", type='item'},
		[4] = {panorama_name = 'panorama_item_4', name = "item_4", price = {don = 100}, itemname = "item_pet_donate_total_dmg", rarity = "#ffa600", text_color = "#ffa600", type='item'},
    }
}
if Shop == nil then
    _G.Shop = class({})
