...
item_desolator_lua8_gem1 = item_desolator_lua8 or class({})
item_desolator_lua8_gem2 = item_desolator_lua8 or class({})
item_desolator_lua8_gem3 = item_desolator_lua8 or class({})
item_desolator_lua8_gem4 = item_desolator_lua8 or class({})
item_desolator_lua8_gem5 = item_desolator_lua8 or class({})

LinkLuaModifier( "modifier_item_desolator_lua_8", "items/items_gems/item_desolator.lua", LUA_MODIFIER_MOTION_NONE )				-- Owner's bonus attributes, stackable
LinkLuaModifier( "modifier_item_desolator_lua_8_debuff", "items/items_gems/item_desolator.lua", LUA_MODIFIER_MOTION_NONE )		-- Armor/vision debuff
