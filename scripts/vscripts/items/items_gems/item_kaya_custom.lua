...
item_kaya_custom_lua8_gem1 = item_kaya_custom_lua1_gem1 or class({})
...
item_kaya_custom_lua8_gem2 = item_kaya_custom_lua1_gem2 or class({})
...
item_kaya_custom_lua8_gem3 = item_kaya_custom_lua1_gem3 or class({})
...
item_kaya_custom_lua8_gem4 = item_kaya_custom_lua1_gem4 or class({})
...
item_kaya_custom_lua8_gem5 = item_kaya_custom_lua1_gem5 or class({})
...
--------------------------------------------------------------------------------
function modifier_item_kaya_custom1:GetAttributes()
...
--------------------------------------------------------------------------------
function modifier_item_kaya_custom5:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end
...
function modifier_item_kaya_custom1:RemoveOnDeath()
	return false
end
function modifier_item_kaya_custom2:RemoveOnDeath()
	return false
end
function modifier_item_kaya_custom3:RemoveOnDeath()
	return false
end
function modifier_item_kaya_custom4:RemoveOnDeath()
	return false
end
function modifier_item_kaya_custom5:RemoveOnDeath()
	return false
end