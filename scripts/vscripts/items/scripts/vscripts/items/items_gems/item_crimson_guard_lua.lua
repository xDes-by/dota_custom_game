...
function modifier_item_crimson_guard_lua1:GetModifierPhysical_ConstantBlock()
...
function modifier_item_crimson_guard_lua2:GetModifierPhysical_ConstantBlock()
	if RandomInt(1, 2) == 1 then
		return self.block_damage
	else
		return 0
...
function modifier_item_crimson_guard_lua3:GetModifierPhysical_ConstantBlock()
	if RandomInt(1, 2) == 1 then
		return self.block_damage
	else
		return 0
...
function modifier_item_crimson_guard_lua4:GetModifierPhysical_ConstantBlock()
	if RandomInt(1, 2) == 1 then
		return self.block_damage
	else
		return 0
...
function modifier_item_crimson_guard_lua5:GetModifierPhysical_ConstantBlock()
	if RandomInt(1, 2) == 1 then
		return self.block_damage
	else
		return 0
