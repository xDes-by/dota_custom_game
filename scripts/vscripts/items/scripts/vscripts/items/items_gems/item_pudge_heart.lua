...
function item_pudge_heart_lua1_gem1:GetChannelTime()
	self.duration = self:GetSpecialValueFor( "duration" )

	return self.duration 
end

function item_pudge_heart_lua1_gem1:OnAbilityPhaseStart()
	if IsServer() then
...
function item_pudge_heart_lua1_gem1:OnChannelFinish( bInterrupted )
	if self.hVictim ~= nil then
...
function item_pudge_heart_lua1_gem2:GetChannelTime()
	self.duration = self:GetSpecialValueFor( "duration" )

	return self.duration 
end

function item_pudge_heart_lua1_gem2:OnAbilityPhaseStart()
	if IsServer() then
		self.hVictim = self:GetCursorTarget()
	end
	return true
...
function item_pudge_heart_lua1_gem2:OnChannelFinish( bInterrupted )
	if self.hVictim ~= nil then
		self.hVictim:RemoveModifierByName( "modifier_item_pudge_heart" )
	end
end
...
function item_pudge_heart_lua1_gem3:GetChannelTime()
	self.duration = self:GetSpecialValueFor( "duration" )

	return self.duration 
end

function item_pudge_heart_lua1_gem3:OnAbilityPhaseStart()
	if IsServer() then
		self.hVictim = self:GetCursorTarget()
	end
	return true
...
function item_pudge_heart_lua1_gem3:OnChannelFinish( bInterrupted )
	if self.hVictim ~= nil then
		self.hVictim:RemoveModifierByName( "modifier_item_pudge_heart" )
	end
end
...
function item_pudge_heart_lua1_gem4:GetChannelTime()
	self.duration = self:GetSpecialValueFor( "duration" )

	return self.duration 
end

function item_pudge_heart_lua1_gem4:OnAbilityPhaseStart()
	if IsServer() then
		self.hVictim = self:GetCursorTarget()
	end
	return true
...
function item_pudge_heart_lua1_gem4:OnChannelFinish( bInterrupted )
	if self.hVictim ~= nil then
		self.hVictim:RemoveModifierByName( "modifier_item_pudge_heart" )
	end
end
...
function item_pudge_heart_lua1_gem5:GetChannelTime()
	self.duration = self:GetSpecialValueFor( "duration" )

	return self.duration 
end

function item_pudge_heart_lua1_gem5:OnAbilityPhaseStart()
	if IsServer() then
		self.hVictim = self:GetCursorTarget()
	end
	return true
...
function item_pudge_heart_lua1_gem5:OnChannelFinish( bInterrupted )
	if self.hVictim ~= nil then
		self.hVictim:RemoveModifierByName( "modifier_item_pudge_heart" )
	end
end
