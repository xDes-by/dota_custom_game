...
function item_veil_of_discord_lua1:OnSpellStart()
	...
	for _,enemy in pairs(enemies) do
		...
		enemy:AddNewModifier(caster, self, "modifier_item_veil_of_discord_active_lua", {duration = self:GetSpecialValueFor("resist_debuff_duration") * (1 - enemy:GetStatusResistance())})
	end
end
-----------------------------------------------------------------------------------
