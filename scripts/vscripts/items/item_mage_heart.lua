item_mage_heart_lua1 = item_mage_heart_lua1 or class({})
item_mage_heart_lua2 = item_mage_heart_lua1 or class({})
item_mage_heart_lua3 = item_mage_heart_lua1 or class({})
item_mage_heart_lua4 = item_mage_heart_lua1 or class({})
item_mage_heart_lua5 = item_mage_heart_lua1 or class({})
item_mage_heart_lua6 = item_mage_heart_lua1 or class({})
item_mage_heart_lua7 = item_mage_heart_lua1 or class({})
item_mage_heart_lua8 = item_mage_heart_lua1 or class({})

LinkLuaModifier("modifier_item_mage_heart_passive", 'items/item_mage_heart.lua', LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_mage_heart", 'items/item_mage_heart.lua', LUA_MODIFIER_MOTION_NONE)

function item_mage_heart_lua1:GetIntrinsicModifierName()
