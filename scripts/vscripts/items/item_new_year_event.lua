...
function item_new_year_event_summon:OnSpellStart()
	...
	boss:AddItemByName("item_assault_lua7_gem4")
	boss:AddItemByName("item_desolator_lua7_gem4")
	boss:AddItemByName("item_greater_crit_lua7_gem4")
	boss:AddItemByName("item_radiance_lua7_gem4")
	boss:AddItemByName("item_kaya_lua7_gem4")
