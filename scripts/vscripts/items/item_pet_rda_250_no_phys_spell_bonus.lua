...
item_pet_RDA_250_no_phys_spell_bonus = class({})

function item_pet_RDA_250_no_phys_spell_bonus:OnSpellStart()
	if IsServer() then
...
function item_pet_RDA_250_no_phys_spell_bonus:GetIntrinsicModifierName()
