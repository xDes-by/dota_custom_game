...
function modifier_rune_mage_damage_increace:OnCreated()
...
function modifier_rune_mage_damage_increace:GetModifierDamageOutgoing_Percentage(data)
    if data.damage_type == DAMAGE_TYPE_MAGICAL then
        return 115
    end
    return 100
end