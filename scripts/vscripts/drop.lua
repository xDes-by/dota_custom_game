...
quest_drop = {
	...
	{name = "item_quest_pivo_bara", items = {"item_quest_pivo_bara"}, chance = 90,  duration = 30, units = {"npc_snow_boss","npc_mega_boss","npc_boss_location8","npc_snow_boss_fake", "npc_mega_boss_fake","npc_boss_location8_fake"}},
}
