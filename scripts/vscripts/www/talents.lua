...
function Talents:ExperienceTicker(pid)
    if not Entities:FindByName( nil, "badguys_creeps") or not Entities:FindByName( nil, "badguys_comandirs") or not Entities:FindByName( nil, "badguys_boss") then 
        self:UpdateGainValue(pid, 0, true)
        return 
    end
