...
_G.basicshop = {
	[1] = {
		...
		[30] = {name = "feed_x250", price = {don = 4, rp = 50}, image = "images/custom_game/pet/shop_feed.png", give = 250, rarity = "#fa3535", text_color = "#fa3535", type ="feed", combinable = true, tooltip = "feed_x250_tooltip"},
		[31] = {name = "feed_x600", price = {don = 8, rp = 150}, image = "images/custom_game/pet/shop_feed.png", give = 600, rarity = "#fa3535", text_color = "#fa3535", type ="feed", combinable = true, tooltip = "feed_x600_tooltip"},
	},
	[2] = {
		name = "consumables",
	...
	[4] = {
		...
		[36] = {name = "other_45", price = {don = 200, rp = 1000}, image = "images/custom_game/DonateShop/heros/cm.png", rarity = "gold", type = "talant", hero = "npc_dota_hero_crystal_maiden",tooltip="shop_image_heros_tooltip"},
...
function Shop:GetPet(t)
	...
	if hero == nil then
		...
		if Shop.pShop[pid][1][1].now == 0 and Shop.pet[pid] ~= nil then return end
