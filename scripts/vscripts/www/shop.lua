...
_G.basicshop = {
	...
	[5] = {
		name = "treasuries",
		[1] = {name = "treasurie1", price = {don = 10, rp = 75}, rarity = "white", image = "images/custom_game/RDAShop/treasuries/1.png", type = "treasuries", tooltip = "", combinable = true, counter = true, layout = "RDAShopItem2", compensation = 15},
		[2] = {name = "treasurie2", price = {don = 10, rp = 75}, rarity = "white", image = "images/custom_game/RDAShop/treasuries/2.png", type = "treasuries", tooltip = "", combinable = true, counter = true, layout = "RDAShopItem2", compensation = 15},
		[3] = {name = "treasurie3", price = {don = 10, rp = 75}, rarity = "white", image = "images/custom_game/RDAShop/treasuries/3.png", type = "treasuries", tooltip = "", combinable = true, counter = true, layout = "RDAShopItem2", compensation = 15},
