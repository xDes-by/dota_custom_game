...
function luna_eclipse_lua:GetAbilityTargetTeam()
	return DOTA_UNIT_TARGET_TEAM_FRIENDLY
end 

function luna_eclipse_lua:GetAbilityTargetType()
	return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC
end 

function luna_eclipse_lua:GetBehavior()
	return self:GetBehaviorInt()
end 

function luna_eclipse_lua:GetBehaviorInt()
	if self:GetCaster():HasScepter() then
