...
function modifier_pugna_ward_winter_2018:DeclareFunctions()
	local funcs = {
...
function modifier_pugna_ward_winter_2018:GetModifierTotal_ConstantBlock(data) 
	if data.target ~= self:GetParent() then return end
	return data.original_damage - 1
end
