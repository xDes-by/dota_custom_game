...
function obsidian_destroyer_sanity_eclipse_lua:GetCooldown(level)
	return self.BaseClass.GetCooldown(self, level) - self:GetCaster():FindTalentValue("special_bonus_unique_outworld_devourer_5")
end	
...
function obsidian_destroyer_sanity_eclipse_lua:OnSpellStart()
	...
	local damage_mana_multiplier = self:GetSpecialValueFor("damage_multiplier") + caster:FindTalentValue("special_bonus_unique_outworld_devourer_4")
