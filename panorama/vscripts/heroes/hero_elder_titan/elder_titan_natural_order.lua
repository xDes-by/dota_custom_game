...
LinkLuaModifier("modifier_elder_titan_natural_order_lua", "heroes/hero_elder_titan/elder_titan_natural_order", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_elder_titan_natural_order_aura_magic_resistance_lua", "heroes/hero_elder_titan/elder_titan_natural_order", LUA_MODIFIER_MOTION_NONE)
...
function modifier_elder_titan_natural_order_lua:OnDestroy()
	...
	if self.parent:GetUnitName() == "npc_dota_elder_titan_ancestral_spirit" then
		if self.owner:HasAbility(self:GetAbility():GetAbilityName()) then
			self.owner:AddNewModifier(self.owner, self.ability, "modifier_elder_titan_natural_order_aura_magic_resistance_lua", {})
		end
	else
