...
LinkLuaModifier("modifier_elder_titan_ancestral_spirit_lua", "heroes/hero_elder_titan/elder_titan_ancestral_spirit", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_elder_titan_ancestral_spirit_buff_lua", "heroes/hero_elder_titan/elder_titan_ancestral_spirit", LUA_MODIFIER_MOTION_NONE)
...
function elder_titan_ancestral_spirit_lua:OnSpellStart()
	...
	self.ancestral_spirit:SetModelScale(1.0 + 0.25 * multicast)
	self.ancestral_spirit:AddNewModifier(self.caster, self, "modifier_elder_titan_ancestral_spirit_lua", {duration = -1, multicast = multicast})	
...
function modifier_elder_titan_ancestral_spirit_lua:OnCreated( kv )
	...
	self.pass_damage = self.ability:GetSpecialValueFor("pass_damage") * kv.multicast
	...
	self.damage_heroes = self.ability:GetSpecialValueFor("damage_heroes") * kv.multicast
	self.damage_creeps = self.ability:GetSpecialValueFor("damage_creeps") * kv.multicast
	self.move_pct_cap = self.ability:GetSpecialValueFor("move_pct_cap")
	self.move_pct_heroes = self.ability:GetSpecialValueFor("move_pct_heroes") * kv.multicast
	self.move_pct_creeps = self.ability:GetSpecialValueFor("move_pct_creeps") * kv.multicast
	self.armor_creeps = self.ability:GetSpecialValueFor("armor_creeps") * kv.multicast
	self.armor_heroes = self.ability:GetSpecialValueFor("armor_heroes") * kv.multicast
