modifier_timbersaw_chakram_thinker_lua = class({})

_STATE_LAUNCHING = "LaunchThink"
_STATE_STAYING = "StayThink"
_STATE_RETURNING = "ReturnThink"

function modifier_timbersaw_chakram_thinker_lua:OnCreated(kv)
	...
	self.disarm_modifier = self.caster:AddNewModifier(self.caster, self.ability, "modifier_timbersaw_chakram_disarm_lua", {})
...
function modifier_timbersaw_chakram_thinker_lua:OnIntervalThink()
...
function modifier_timbersaw_chakram_thinker_lua:OnDestroy()
...
function modifier_timbersaw_chakram_thinker_lua:LaunchThink()
...
function modifier_timbersaw_chakram_thinker_lua:StayThink()
...
function modifier_timbersaw_chakram_thinker_lua:ReturnThink()
...
function modifier_timbersaw_chakram_thinker_lua:Return()
...
function modifier_timbersaw_chakram_thinker_lua:Move(target_point)
...
function modifier_timbersaw_chakram_thinker_lua:Damage(target_point, is_staying)
	...
	local function _damage(enemy)
		...
		enemy:AddNewModifier(self.caster, self.ability, "modifier_timbersaw_chakram_slow_lua", { 
			duration = enemy:ApplyStatusResistance(self.duration)
		})
