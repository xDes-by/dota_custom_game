...
function CustomChat:Init()
    ...
    CustomGameEventManager:RegisterListener("alt_ping_mastery",function(_, data)
        self:AltPingMastery(data)
    end)
end

function CustomChat:AltPingMastery(data)
	CustomGameEventManager:Send_ServerToAllClients("alt_ping_mastery", data)
end
