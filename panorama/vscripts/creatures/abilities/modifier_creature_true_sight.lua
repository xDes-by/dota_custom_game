...
function modifier_creature_true_sight:IsHidden() return true end
function modifier_creature_true_sight:IsDebuff() return false end
function modifier_creature_true_sight:IsPurgable() return false end

function modifier_creature_true_sight:GetTexture() return "item_gem" end
