...
item_ranged_cleave_2 = item_ranged_cleave or class({})

LinkLuaModifier("modifier_item_ranged_cleave", "items/ranged_cleave", LUA_MODIFIER_MOTION_NONE)
...
function modifier_item_ranged_cleave:GetModifierBonusStats_Strength() return self.bonus_str end
function modifier_item_ranged_cleave:GetModifierBonusStats_Agility() return self.bonus_agi end
function modifier_item_ranged_cleave:GetModifierPreAttack_BonusDamage() return self.bonus_dmg end
